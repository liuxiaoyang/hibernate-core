 ...
 * 
 */
@Generated(value = "org.jboss.logging.processor.model.MessageLoggerImplementor", date = "2013-07-02T11:21:33+1000")
    ...
    implements Serializable, CoreMessageLogger, BasicLogger
{
    ...
    private final static String explicitSkipLockedLockCombo = "Explicit use of UPGRADE_SKIPLOCKED in lock() calls is not recommended; use normal UPGRADE locking instead";
    ...
    public final void JavaSqlTypesMappedSameCodeMultipleTimes(final int code, final String old, final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000141: ")+ JavaSqlTypesMappedSameCodeMultipleTimes$str()), code, old, name);
    }
    ...
    public final void naturalIdMaxQueryTime(final long naturalIdQueryExecutionMaxTime) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000441: ")+ naturalIdMaxQueryTime$str()), naturalIdQueryExecutionMaxTime);
    }
    ...
    public final void logicalConnectionReleasingPhysicalConnection() {
        super.log.logf(FQCN, (Logger.Level.DEBUG), null, ((projectCode +"000163: ")+ logicalConnectionReleasingPhysicalConnection$str()));
    }
    ...
    public final void logicalConnectionClosed() {
        super.log.logf(FQCN, (Logger.Level.DEBUG), null, ((projectCode +"000162: ")+ logicalConnectionClosed$str()));
    }
    ...
    public final void readingMappingsFromFile(final String path) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000220: ")+ readingMappingsFromFile$str()), path);
    }
    ...
    public final void unregisteredStatement() {
        super.log.logf(FQCN, (Logger.Level.DEBUG), null, ((projectCode +"000387: ")+ unregisteredStatement$str()));
    }
    ...
    public final void unableToTransformClass(final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000373: ")+ unableToTransformClass$str()), message);
    }
    ...
    public final void collectionsFetched(final long collectionFetchCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000032: ")+ collectionsFetched$str()), collectionFetchCount);
    }
    ...
    public final void unknownOracleVersion(final int databaseMajorVersion) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000384: ")+ unknownOracleVersion$str()), databaseMajorVersion);
    }
    ...
    public final void configuringFromResource(final String resource) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000043: ")+ configuringFromResource$str()), resource);
    }
    ...
    public final void timestampCachePuts(final long updateTimestampsCachePutCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000433: ")+ timestampCachePuts$str()), updateTimestampsCachePutCount);
    }
    ...
    public final void unableToDetermineLockModeValue(final String hintName, final Object value) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000311: ")+ unableToDetermineLockModeValue$str()), hintName, value);
    }
    ...
    public final void deprecatedOracle9Dialect() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000063: ")+ deprecatedOracle9Dialect$str()));
    }
    ...
    public final void renamedProperty(final Object propertyName, final Object newPropertyName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000225: ")+ renamedProperty$str()), propertyName, newPropertyName);
    }
    ...
    public final void disablingContextualLOBCreationSinceConnectionNull() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000422: ")+ disablingContextualLOBCreationSinceConnectionNull$str()));
    }
    ...
    public final void schemaUpdateComplete() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000232: ")+ schemaUpdateComplete$str()));
    }
    ...
    public final void usingStreams() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000407: ")+ usingStreams$str()));
    }
    ...
    public final void alreadySessionBound() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000002: ")+ alreadySessionBound$str()));
    }
    ...
    public final void unableToLocateCustomOptimizerClass(final String type) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000321: ")+ unableToLocateCustomOptimizerClass$str()), type);
    }
    ...
    public final void disallowingInsertStatementComment() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000067: ")+ disallowingInsertStatementComment$str()));
    }
    ...
    public final void connectionProperties(final Properties connectionProps) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000046: ")+ connectionProperties$str()), connectionProps);
    }
    ...
    public final void loggingStatistics() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000161: ")+ loggingStatistics$str()));
    }
    ...
    public final void proxoolProviderClassNotFound(final String proxoolProviderClassName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000209: ")+ proxoolProviderClassNotFound$str()), proxoolProviderClassName);
    }
    ...
    public final void unableToReleaseCacheLock(final CacheException ce) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000353: ")+ unableToReleaseCacheLock$str()), ce);
    }
    ...
    public final void queryCachePuts(final long queryCachePutCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000215: ")+ queryCachePuts$str()), queryCachePutCount);
    }
    ...
    public final void sessionsClosed(final long sessionCloseCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000241: ")+ sessionsClosed$str()), sessionCloseCount);
    }
    ...
    public final void compositeIdClassDoesNotOverrideEquals(final String name) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000038: ")+ compositeIdClassDoesNotOverrideEquals$str()), name);
    }
    ...
    public final void unableToDiscoverOsgiService(final String service, final Exception e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000450: ")+ unableToDiscoverOsgiService$str()), service);
    }
    ...
    public final void disablingContextualLOBCreationSinceCreateClobFailed(final Throwable t) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000424: ")+ disablingContextualLOBCreationSinceCreateClobFailed$str()), t);
    }
    ...
    public final void invalidEditOfReadOnlyItem(final Object key) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000134: ")+ invalidEditOfReadOnlyItem$str()), key);
    }
    ...
    public final void noSessionFactoryWithJndiName(final String sfJNDIName, final NameNotFoundException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000184: ")+ noSessionFactoryWithJndiName$str()), sfJNDIName);
    }
    ...
    public final void duplicateMetadata() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000074: ")+ duplicateMetadata$str()));
    }
    ...
    public final void orderByAnnotationIndexedCollection() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000189: ")+ orderByAnnotationIndexedCollection$str()));
    }
    ...
    public final void typeDefinedNoRegistrationKeys(final BasicType type) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000269: ")+ typeDefinedNoRegistrationKeys$str()), type);
    }
    ...
    public final void schemaExportComplete() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000230: ")+ schemaExportComplete$str()));
    }
    ...
    public final void secondLevelCachePuts(final long secondLevelCachePutCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000239: ")+ secondLevelCachePuts$str()), secondLevelCachePutCount);
    }
    ...
    public final void unableToExecuteBatch(final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000315: ")+ unableToExecuteBatch$str()), message);
    }
    ...
    public final void unableToConfigureSqlExceptionConverter(final org.hibernate.HibernateException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000301: ")+ unableToConfigureSqlExceptionConverter$str()), e);
    }
    ...
    public final void unsupportedProperty(final Object propertyName, final Object newPropertyName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000395: ")+ unsupportedProperty$str()), propertyName, newPropertyName);
    }
    ...
    public final void invalidJndiName(final String name, final JndiNameException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000135: ")+ invalidJndiName$str()), name);
    }
    ...
    public final void unableToAccessEjb3Configuration(final NamingException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000271: ")+ unableToAccessEjb3Configuration$str()));
    }
    ...
    public final void unableToCloseStream(final IOException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000296: ")+ unableToCloseStream$str()));
    }
    ...
    public final void factoryJndiRename(final String oldName, final String newName) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000096: ")+ factoryJndiRename$str()), oldName, newName);
    }
    ...
    public final void unsuccessful(final String sql) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000388: ")+ unsuccessful$str()), sql);
    }
    ...
    public final void duplicateListener(final String className) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000073: ")+ duplicateListener$str()), className);
    }
    ...
    public final void unableToCloseOutputFile(final String outputFile, final IOException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000291: ")+ unableToCloseOutputFile$str()), outputFile);
    }
    ...
    public final void unableToLoadCommand(final org.hibernate.HibernateException e) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000327: ")+ unableToLoadCommand$str()), e);
    }
    ...
    public final void hql(final String hql, final Long valueOf, final Long valueOf2) {
        super.log.logf(FQCN, (Logger.Level.DEBUG), null, ((projectCode +"000117: ")+ hql$str()), hql, valueOf, valueOf2);
    }
    ...
    public final void unableToCleanUpPreparedStatement(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000282: ")+ unableToCleanUpPreparedStatement$str()));
    }
    ...
    public final void tooManyInExpressions(final String dialectName, final int limit, final String paramName, final int size) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000443: ")+ tooManyInExpressions$str()), dialectName, limit, paramName, size);
    }
    ...
    public final void usingDefaultIdGeneratorSegmentValue(final String tableName, final String segmentColumnName, final String defaultToUse) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000398: ")+ usingDefaultIdGeneratorSegmentValue$str()), tableName, segmentColumnName, defaultToUse);
    }
    ...
    public final void unsuccessfulCreate(final String string) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000389: ")+ unsuccessfulCreate$str()), string);
    }
    ...
    public final void namedQueryError(final String queryName, final org.hibernate.HibernateException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000177: ")+ namedQueryError$str()), queryName);
    }
    ...
    public final void cleaningUpConnectionPool(final String url) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000030: ")+ cleaningUpConnectionPool$str()), url);
    }
    ...
    public final void unableToClosePooledConnection(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000293: ")+ unableToClosePooledConnection$str()));
    }
    ...
    public final void unableToCloseInputStream(final IOException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000287: ")+ unableToCloseInputStream$str()));
    }
    ...
    public final void bytecodeProvider(final String provider) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000021: ")+ bytecodeProvider$str()), provider);
    }
    ...
    public final void unableToUnbindFactoryFromJndi(final org.hibernate.engine.jndi.JndiException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000374: ")+ unableToUnbindFactoryFromJndi$str()));
    }
    ...
    public final void unableToRollbackIsolatedTransaction(final Exception e, final Exception ignore) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000364: ")+ unableToRollbackIsolatedTransaction$str()), e, ignore);
    }
    ...
    public final void gettersOfLazyClassesCannotBeFinal(final String entityName, final String name) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000112: ")+ gettersOfLazyClassesCannotBeFinal$str()), entityName, name);
    }
    ...
    public final void unableToCloseInputFiles(final String name, final IOException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000286: ")+ unableToCloseInputFiles$str()), name);
    }
    ...
    public final void secondLevelCacheHits(final long secondLevelCacheHitCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000237: ")+ secondLevelCacheHits$str()), secondLevelCacheHitCount);
    }
    ...
    public final void collectionsUpdated(final long collectionUpdateCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000036: ")+ collectionsUpdated$str()), collectionUpdateCount);
    }
    ...
    public final void unableToObjectConnectionToQueryMetadata(final SQLException error) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000340: ")+ unableToObjectConnectionToQueryMetadata$str()), error);
    }
    ...
    public final void recognizedObsoleteHibernateNamespace(final String oldHibernateNamespace, final String hibernateNamespace) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000223: ")+ recognizedObsoleteHibernateNamespace$str()), oldHibernateNamespace, hibernateNamespace);
    }
    ...
    public final void unableToLogWarnings(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000336: ")+ unableToLogWarnings$str()));
    }
    ...
    public final void unregisteredResultSetWithoutStatement() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000386: ")+ unregisteredResultSetWithoutStatement$str()));
    }
    ...
    public final void autoCommitMode(final boolean autocommit) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000006: ")+ autoCommitMode$str()), autocommit);
    }
    ...
    public final void duplicateJoins(final String entityName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000072: ")+ duplicateJoins$str()), entityName);
    }
    ...
    public final void unableToResolveAggregateFunction(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000359: ")+ unableToResolveAggregateFunction$str()), name);
    }
    ...
    public final void unableToCloseStreamError(final IOException error) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000297: ")+ unableToCloseStreamError$str()), error);
    }
    ...
    public final void forcingTableUse() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000107: ")+ forcingTableUse$str()));
    }
    ...
    public final void aliasSpecificLockingWithFollowOnLocking(final LockMode lockMode) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000445: ")+ aliasSpecificLockingWithFollowOnLocking$str()), lockMode);
    }
    ...
    public final void hibernateConnectionPoolSize(final int poolSize) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000115: ")+ hibernateConnectionPoolSize$str()), poolSize);
    }
    ...
    public final void configuringFromUrl(final URL url) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000044: ")+ configuringFromUrl$str()), url);
    }
    ...
    public final void jdbcAutoCommitFalseBreaksEjb3Spec(final String autocommit) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000144: ")+ jdbcAutoCommitFalseBreaksEjb3Spec$str()), autocommit);
    }
    ...
    public final void unableToAccessSessionFactory(final String sfJNDIName, final NamingException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000272: ")+ unableToAccessSessionFactory$str()), sfJNDIName);
    }
    ...
    public final void scopingTypesToSessionFactoryAfterAlreadyScoped(final org.hibernate.engine.spi.SessionFactoryImplementor factory, final org.hibernate.engine.spi.SessionFactoryImplementor factory2) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000233: ")+ scopingTypesToSessionFactoryAfterAlreadyScoped$str()), factory, factory2);
    }
    ...
    public final void usingDriver(final String driverClassName, final String url) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000401: ")+ usingDriver$str()), driverClassName, url);
    }
    ...
    public final void unableToReleaseBatchStatement() {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000352: ")+ unableToReleaseBatchStatement$str()));
    }
    ...
    public final void entityManagerClosedBySomeoneElse(final String autoCloseSession) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000082: ")+ entityManagerClosedBySomeoneElse$str()), autoCloseSession);
    }
    ...
    public final void unableToExecuteResolver(final DialectResolver abstractDialectResolver, final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000316: ")+ unableToExecuteResolver$str()), abstractDialectResolver, message);
    }
    ...
    public final void unknownBytecodeProvider(final String providerName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000382: ")+ unknownBytecodeProvider$str()), providerName);
    }
    ...
    public final void collectionsRemoved(final long collectionRemoveCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000035: ")+ collectionsRemoved$str()), collectionRemoveCount);
    }
    ...
    public final void unexpectedRowCounts() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000381: ")+ unexpectedRowCounts$str()));
    }
    ...
    public final void stoppingService() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000255: ")+ stoppingService$str()));
    }
    ...
    public final void unexpectedLiteralTokenType(final int type) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000380: ")+ unexpectedLiteralTokenType$str()), type);
    }
    ...
    public final void unableToCloseSessionDuringRollback(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000295: ")+ unableToCloseSessionDuringRollback$str()));
    }
    ...
    public final void unableToSetTransactionToRollbackOnly(final SystemException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000367: ")+ unableToSetTransactionToRollbackOnly$str()));
    }
    ...
    public final void unableToCompleteSchemaUpdate(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000299: ")+ unableToCompleteSchemaUpdate$str()));
    }
    ...
    public final void entitiesFetched(final long entityFetchCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000077: ")+ entitiesFetched$str()), entityFetchCount);
    }
    ...
    public final void unableToObtainConnectionToQueryMetadata(final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000342: ")+ unableToObtainConnectionToQueryMetadata$str()), message);
    }
    ...
    public final void unableToPerformManagedFlush(final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000346: ")+ unableToPerformManagedFlush$str()), message);
    }
    ...
    public final void splitQueries(final String sourceQuery, final int length) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000245: ")+ splitQueries$str()), sourceQuery, length);
    }
    ...
    public final void entityIdentifierValueBindingExists(final String name) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000429: ")+ entityIdentifierValueBindingExists$str()), name);
    }
    ...
    public final void deprecatedForceDescriminatorAnnotation() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000062: ")+ deprecatedForceDescriminatorAnnotation$str()));
    }
    ...
    public final void foreignKeys(final Set keySet) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000108: ")+ foreignKeys$str()), keySet);
    }
    ...
    public final void timestampCacheHits(final long updateTimestampsCachePutCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000434: ")+ timestampCacheHits$str()), updateTimestampsCachePutCount);
    }
    ...
    public final void factoryBoundToJndiName(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000094: ")+ factoryBoundToJndiName$str()), name);
    }
    ...
    public final void unableToInstantiateUuidGenerationStrategy(final Exception ignore) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000325: ")+ unableToInstantiateUuidGenerationStrategy$str()), ignore);
    }
    ...
    public final void entitiesLoaded(final long entityLoadCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000079: ")+ entitiesLoaded$str()), entityLoadCount);
    }
    ...
    public final void setManagerLookupClass() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000426: ")+ setManagerLookupClass$str()));
    }
    ...
    public final void version(final String versionString) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000412: ")+ version$str()), versionString);
    }
    ...
    public final void unableToBindFactoryToJndi(final org.hibernate.engine.jndi.JndiException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000277: ")+ unableToBindFactoryToJndi$str()));
    }
    ...
    public final void unableToCloseIterator(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.INFO), (e), ((projectCode +"000289: ")+ unableToCloseIterator$str()));
    }
    ...
    public final void unableToAccessTypeInfoResultSet(final String string) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000273: ")+ unableToAccessTypeInfoResultSet$str()), string);
    }
    ...
    public final void sessionsOpened(final long sessionOpenCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000242: ")+ sessionsOpened$str()), sessionOpenCount);
    }
    ...
    public final void unableToReadClass(final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000348: ")+ unableToReadClass$str()), message);
    }
    ...
    public final void unableToSwitchToMethodUsingColumnIndex(final Method method) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000370: ")+ unableToSwitchToMethodUsingColumnIndex$str()), method);
    }
    ...
    public final void synchronizationAlreadyRegistered(final javax.transaction.Synchronization synchronization) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000259: ")+ synchronizationAlreadyRegistered$str()), synchronization);
    }
    ...
    public final void tableNotFound(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000262: ")+ tableNotFound$str()), name);
    }
    ...
    public final void warningsCreatingTempTable(final SQLWarning warning) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000413: ")+ warningsCreatingTempTable$str()), warning);
    }
    ...
    public final void jdbcDriverNotSpecified(final String driver) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000148: ")+ jdbcDriverNotSpecified$str()), driver);
    }
    ...
    public final void noAppropriateConnectionProvider() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000181: ")+ noAppropriateConnectionProvider$str()));
    }
    ...
    public final void hsqldbSupportsOnlyReadCommittedIsolation() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000118: ")+ hsqldbSupportsOnlyReadCommittedIsolation$str()));
    }
    ...
    public final void startTime(final long startTime) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000251: ")+ startTime$str()), startTime);
    }
    ...
    public final void successfulTransactions(final long committedTransactionCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000258: ")+ successfulTransactions$str()), committedTransactionCount);
    }
    ...
    public final void guidGenerated(final String result) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000113: ")+ guidGenerated$str()), result);
    }
    ...
    public final void startingServiceAtJndiName(final String boundName) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000249: ")+ startingServiceAtJndiName$str()), boundName);
    }
    ...
    public final void unableToConstructSqlExceptionConverter(final Throwable t) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000303: ")+ unableToConstructSqlExceptionConverter$str()), t);
    }
    ...
    public final void runningSchemaValidator() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000229: ")+ runningSchemaValidator$str()));
    }
    ...
    public final void unableToRollbackConnection(final Exception ignore) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000363: ")+ unableToRollbackConnection$str()), ignore);
    }
    ...
    public final void unableToApplyConstraints(final String className, final Exception e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000274: ")+ unableToApplyConstraints$str()), className);
    }
    ...
    public final void runningHbm2ddlSchemaExport() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000227: ")+ runningHbm2ddlSchemaExport$str()));
    }
    ...
    public final void unableToLocateMBeanServer() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000332: ")+ unableToLocateMBeanServer$str()));
    }
    ...
    public final void invalidTableAnnotation(final String className) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000139: ")+ invalidTableAnnotation$str()), className);
    }
    ...
    public final void batchContainedStatementsOnRelease() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000010: ")+ batchContainedStatementsOnRelease$str()));
    }
    ...
    public final void usingReflectionOptimizer() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000406: ")+ usingReflectionOptimizer$str()));
    }
    ...
    public final void unableToDeserializeCache(final String path, final SerializationException error) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000307: ")+ unableToDeserializeCache$str()), path, error);
    }
    ...
    public final void cacheProvider(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000024: ")+ cacheProvider$str()), name);
    }
    ...
    public final void unknownIngresVersion(final int databaseMajorVersion) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000383: ")+ unknownIngresVersion$str()), databaseMajorVersion);
    }
    ...
    public final void unableToUpdateQueryHiValue(final String tableName, final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000376: ")+ unableToUpdateQueryHiValue$str()), tableName);
    }
    ...
    public final void unableToBuildSessionFactoryUsingMBeanClasspath(final String message) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000280: ")+ unableToBuildSessionFactoryUsingMBeanClasspath$str()), message);
    }
    ...
    public final void callingJoinTransactionOnNonJtaEntityManager() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000027: ")+ callingJoinTransactionOnNonJtaEntityManager$str()));
    }
    ...
    public final void namingExceptionAccessingFactory(final NamingException exception) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000178: ")+ namingExceptionAccessingFactory$str()), exception);
    }
    ...
    public final void configuringFromFile(final String file) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000042: ")+ configuringFromFile$str()), file);
    }
    ...
    public final void typeRegistrationOverridesPrevious(final String key, final Type old) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000270: ")+ typeRegistrationOverridesPrevious$str()), key, old);
    }
    ...
    public final void timestampCacheMisses(final long updateTimestampsCachePutCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000435: ")+ timestampCacheMisses$str()), updateTimestampsCachePutCount);
    }
    ...
    public final void processingPersistenceUnitInfoName(final String persistenceUnitName) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000204: ")+ processingPersistenceUnitInfoName$str()), persistenceUnitName);
    }
    ...
    public final void localLoadingCollectionKeysCount(final int size) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000160: ")+ localLoadingCollectionKeysCount$str()), size);
    }
    ...
    public final void multipleValidationModes(final String modes) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000448: ")+ multipleValidationModes$str()), modes);
    }
    ...
    public final void firstOrMaxResultsSpecifiedWithCollectionFetch() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000104: ")+ firstOrMaxResultsSpecifiedWithCollectionFetch$str()));
    }
    ...
    public final void queryCacheMisses(final long queryCacheMissCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000214: ")+ queryCacheMisses$str()), queryCacheMissCount);
    }
    ...
    public final void deprecatedUuidGenerator(final String name, final String name2) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000065: ")+ deprecatedUuidGenerator$str()), name, name2);
    }
    ...
    public final void usingFollowOnLocking() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000444: ")+ usingFollowOnLocking$str()));
    }
    ...
    public final void illegalPropertyGetterArgument(final String name, final String propertyName) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000122: ")+ illegalPropertyGetterArgument$str()), name, propertyName);
    }
    ...
    public final void propertiesLoaded(final Properties maskOut) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000205: ")+ propertiesLoaded$str()), maskOut);
    }
    ...
    public final void unableToStopService(final Class class1, final String string) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000369: ")+ unableToStopService$str()), class1, string);
    }
    ...
    public final void maxQueryTime(final long queryExecutionMaxTime) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000173: ")+ maxQueryTime$str()), queryExecutionMaxTime);
    }
    ...
    public final void factoryUnboundFromName(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000098: ")+ factoryUnboundFromName$str()), name);
    }
    ...
    public final void parsingXmlError(final int lineNumber, final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000196: ")+ parsingXmlError$str()), lineNumber, message);
    }
    ...
    public final void providerClassDeprecated(final String providerClassName, final String actualProviderClassName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000208: ")+ providerClassDeprecated$str()), providerClassName, actualProviderClassName);
    }
    ...
    public final void unsupportedAfterStatement() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000390: ")+ unsupportedAfterStatement$str()));
    }
    ...
    public final void expectedType(final String name, final String string) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000091: ")+ expectedType$str()), name, string);
    }
    ...
    public final void unableToRetrieveCache(final String namespace, final String message) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000361: ")+ unableToRetrieveCache$str()), namespace, message);
    }
    ...
    public final void definingFlushBeforeCompletionIgnoredInHem(final String flushBeforeCompletion) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000059: ")+ definingFlushBeforeCompletionIgnoredInHem$str()), flushBeforeCompletion);
    }
    ...
    public final void embedXmlAttributesNoLongerSupported() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000446: ")+ embedXmlAttributesNoLongerSupported$str()));
    }
    ...
    public final void subResolverException(final String message) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000257: ")+ subResolverException$str()), message);
    }
    ...
    public final void unableToCloseSessionButSwallowingError(final org.hibernate.HibernateException e) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000425: ")+ unableToCloseSessionButSwallowingError$str()), e);
    }
    ...
    public final void jaccContextId(final String contextId) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000140: ")+ jaccContextId$str()), contextId);
    }
    ...
    public final void naturalIdQueriesExecuted(final long naturalIdQueriesExecutionCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000442: ")+ naturalIdQueriesExecuted$str()), naturalIdQueriesExecutionCount);
    }
    ...
    public final void unableToJoinTransaction(final String transactionStrategy) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000326: ")+ unableToJoinTransaction$str()), transactionStrategy);
    }
    ...
    public final void sqlExceptionEscapedProxy(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000246: ")+ sqlExceptionEscapedProxy$str()));
    }
    ...
    public final void unsupportedMultiTableBulkHqlJpaql(final int majorVersion, final int minorVersion, final int buildId) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000393: ")+ unsupportedMultiTableBulkHqlJpaql$str()), majorVersion, minorVersion, buildId);
    }
    ...
    public final void unableToDestroyQueryCache(final String region, final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000309: ")+ unableToDestroyQueryCache$str()), region, message);
    }
    ...
    public final void noPersistentClassesFound(final String query) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000183: ")+ noPersistentClassesFound$str()), query);
    }
    ...
    public final void disablingContextualLOBCreation(final String nonContextualLobCreation) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000421: ")+ disablingContextualLOBCreation$str()), nonContextualLobCreation);
    }
    ...
    public final void sqlWarning(final int errorCode, final String sqlState) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000247: ")+ sqlWarning$str()), errorCode, sqlState);
    }
    ...
    public final void containerProvidingNullPersistenceUnitRootUrl() {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000050: ")+ containerProvidingNullPersistenceUnitRootUrl$str()));
    }
    ...
    public final void unableToDestroyUpdateTimestampsCache(final String region, final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000310: ")+ unableToDestroyUpdateTimestampsCache$str()), region, message);
    }
    ...
    public final void unableToStopHibernateService(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000368: ")+ unableToStopHibernateService$str()));
    }
    ...
    public final void duplicateGeneratorTable(final String name) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000070: ")+ duplicateGeneratorTable$str()), name);
    }
    ...
    public final void writeLocksNotSupported(final String entityName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000416: ")+ writeLocksNotSupported$str()), entityName);
    }
    ...
    public final void unableToReleaseCreatedMBeanServer(final String string) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000355: ")+ unableToReleaseCreatedMBeanServer$str()), string);
    }
    ...
    public final void entityAnnotationOnNonRoot(final String className) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000081: ")+ entityAnnotationOnNonRoot$str()), className);
    }
    ...
    public final void unableToReadColumnValueFromResultSet(final String name, final String message) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000349: ")+ unableToReadColumnValueFromResultSet$str()), name, message);
    }
    ...
    public final void narrowingProxy(final Class concreteProxyClass) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000179: ")+ narrowingProxy$str()), concreteProxyClass);
    }
    ...
    public final void c3p0ProviderClassNotFound(final String c3p0ProviderClassName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000022: ")+ c3p0ProviderClassNotFound$str()), c3p0ProviderClassName);
    }
    ...
    public final void runningHbm2ddlSchemaUpdate() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000228: ")+ runningHbm2ddlSchemaUpdate$str()));
    }
    ...
    public final void unableToCloseJar(final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000290: ")+ unableToCloseJar$str()), message);
    }
    ...
    public final void queriesExecuted(final long queryExecutionCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000210: ")+ queriesExecuted$str()), queryExecutionCount);
    }
    ...
    public final void unableToResolveMappingFile(final String xmlFile) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000360: ")+ unableToResolveMappingFile$str()), xmlFile);
    }
    ...
    public final void illegalPropertySetterArgument(final String name, final String propertyName) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000123: ")+ illegalPropertySetterArgument$str()), name, propertyName);
    }
    ...
    public final void autoFlushWillNotWork() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000008: ")+ autoFlushWillNotWork$str()));
    }
    ...
    public final void parameterPositionOccurredAsBothJpaAndHibernatePositionalParameter(final Integer position) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000195: ")+ parameterPositionOccurredAsBothJpaAndHibernatePositionalParameter$str()), position);
    }
    ...
    public final void readingMappingsFromResource(final String resourceName) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000221: ")+ readingMappingsFromResource$str()), resourceName);
    }
    ...
    public final void usingTimestampWorkaround() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000408: ")+ usingTimestampWorkaround$str()));
    }
    ...
    public final void unableToObjectConnectionMetadata(final SQLException error) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000339: ")+ unableToObjectConnectionMetadata$str()), error);
    }
    ...
    public final void processEqualityExpression() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000203: ")+ processEqualityExpression$str()));
    }
    ...
    public final void unableToReleaseTypeInfoResultSet() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000357: ")+ unableToReleaseTypeInfoResultSet$str()));
    }
    ...
    public final void unableToMarkForRollbackOnTransientObjectException(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000338: ")+ unableToMarkForRollbackOnTransientObjectException$str()));
    }
    ...
    public final void ignoringTableGeneratorConstraints(final String name) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000120: ")+ ignoringTableGeneratorConstraints$str()), name);
    }
    ...
    public final void rdmsOs2200Dialect() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000218: ")+ rdmsOs2200Dialect$str()));
    }
    ...
    public final void pooledOptimizerReportedInitialValue(final IntegralDataTypeHolder value) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000201: ")+ pooledOptimizerReportedInitialValue$str()), value);
    }
    ...
    public final void sortAnnotationIndexedCollection() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000244: ")+ sortAnnotationIndexedCollection$str()));
    }
    ...
    public final void instantiatingExplicitConnectionProvider(final String providerClassName) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000130: ")+ instantiatingExplicitConnectionProvider$str()), providerClassName);
    }
    ...
    public final void cannotResolveNonNullableTransientDependencies(final String transientEntityString, final Set dependentEntityStrings, final Set nonNullableAssociationPaths) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000437: ")+ cannotResolveNonNullableTransientDependencies$str()), transientEntityString, dependentEntityStrings, nonNullableAssociationPaths);
    }
    ...
    public final void addingOverrideFor(final String name, final String name2) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000418: ")+ addingOverrideFor$str()), name, name2);
    }
    ...
    public final void settersOfLazyClassesCannotBeFinal(final String entityName, final String name) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000243: ")+ settersOfLazyClassesCannotBeFinal$str()), entityName, name);
    }
    ...
    public final void transactions(final long transactionCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000266: ")+ transactions$str()), transactionCount);
    }
    ...
    public final void unableToSynchronizeDatabaseStateWithSession(final org.hibernate.HibernateException he) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000371: ")+ unableToSynchronizeDatabaseStateWithSession$str()), he);
    }
    ...
    public final void persistenceProviderCallerDoesNotImplementEjb3SpecCorrectly() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000200: ")+ persistenceProviderCallerDoesNotImplementEjb3SpecCorrectly$str()));
    }
    ...
    public final void lazyPropertyFetchingAvailable(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000157: ")+ lazyPropertyFetchingAvailable$str()), name);
    }
    ...
    public final void usingDialect(final Dialect dialect) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000400: ")+ usingDialect$str()), dialect);
    }
    ...
    public final void foundMappingDocument(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000109: ")+ foundMappingDocument$str()), name);
    }
    ...
    public final void incompleteMappingMetadataCacheProcessing() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000125: ")+ incompleteMappingMetadataCacheProcessing$str()));
    }
    ...
    public final void usingUuidHexGenerator(final String name, final String name2) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000409: ")+ usingUuidHexGenerator$str()), name, name2);
    }
    ...
    public final void tableFound(final String string) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000261: ")+ tableFound$str()), string);
    }
    ...
    public final void unableToGetDatabaseMetadata(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000319: ")+ unableToGetDatabaseMetadata$str()));
    }
    ...
    public final void undeterminedH2Version() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000431: ")+ undeterminedH2Version$str()));
    }
    ...
    public final void deprecatedOracleDialect() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000064: ")+ deprecatedOracleDialect$str()));
    }
    ...
    public final void invalidOnDeleteAnnotation(final String entityName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000136: ")+ invalidOnDeleteAnnotation$str()), entityName);
    }
    ...
    public final void resolvedSqlTypeDescriptorForDifferentSqlCode(final String name, final String valueOf, final String name2, final String valueOf2) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000419: ")+ resolvedSqlTypeDescriptorForDifferentSqlCode$str()), name, valueOf, name2, valueOf2);
    }
    ...
    public final void unableToParseMetadata(final String packageName) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000344: ")+ unableToParseMetadata$str()), packageName);
    }
    ...
    public final void parsingXmlWarning(final int lineNumber, final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000198: ")+ parsingXmlWarning$str()), lineNumber, message);
    }
    ...
    public final void propertyNotFound(final String property) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000207: ")+ propertyNotFound$str()), property);
    }
    ...
    public final void unableToCleanupTemporaryIdTable(final Throwable t) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000283: ")+ unableToCleanupTemporaryIdTable$str()), t);
    }
    ...
    public final void closing() {
        super.log.logf(FQCN, (Logger.Level.DEBUG), null, ((projectCode +"000031: ")+ closing$str()));
    }
    ...
    public final void entityMappedAsNonAbstract(final String name) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000084: ")+ entityMappedAsNonAbstract$str()), name);
    }
    ...
    public final void collectionsRecreated(final long collectionRecreateCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000034: ")+ collectionsRecreated$str()), collectionRecreateCount);
    }
    ...
    public final void statementsClosed(final long closeStatementCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000252: ")+ statementsClosed$str()), closeStatementCount);
    }
    ...
    public final void unableToConstructCurrentSessionContext(final String impl, final Throwable e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000302: ")+ unableToConstructCurrentSessionContext$str()), impl);
    }
    ...
    public final void unableToCloseOutputStream(final IOException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000292: ")+ unableToCloseOutputStream$str()));
    }
    ...
    public final void unableToCloseSession(final org.hibernate.HibernateException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000294: ")+ unableToCloseSession$str()));
    }
    ...
    public final void transactionStartedOnNonRootSession() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000267: ")+ transactionStartedOnNonRootSession$str()));
    }
    ...
    public final void entitiesUpdated(final long entityUpdateCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000080: ")+ entitiesUpdated$str()), entityUpdateCount);
    }
    ...
    public final void legacyTransactionManagerStrategy(final String name, final String jtaPlatform) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000428: ")+ legacyTransactionManagerStrategy$str()), name, jtaPlatform);
    }
    ...
    public final void unsupportedOracleVersion() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000394: ")+ unsupportedOracleVersion$str()));
    }
    ...
    public final void indexes(final Set keySet) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000126: ")+ indexes$str()), keySet);
    }
    ...
    public final void unableToLocateUuidGenerationStrategy(final String strategyClassName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000334: ")+ unableToLocateUuidGenerationStrategy$str()), strategyClassName);
    }
    ...
    public final void disablingContextualLOBCreationSinceOldJdbcVersion(final int jdbcMajorVersion) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000423: ")+ disablingContextualLOBCreationSinceOldJdbcVersion$str()), jdbcMajorVersion);
    }
    ...
    public final void parsingXmlWarningForFile(final String file, final int lineNumber, final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000199: ")+ parsingXmlWarningForFile$str()), file, lineNumber, message);
    }
    ...
    public final void missingEntityAnnotation(final String className) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000175: ")+ missingEntityAnnotation$str()), className);
    }
    ...
    public final void startingUpdateTimestampsCache(final String region) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000250: ")+ startingUpdateTimestampsCache$str()), region);
    }
    ...
    public final void unableToRetrieveTypeInfoResultSet(final String string) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000362: ")+ unableToRetrieveTypeInfoResultSet$str()), string);
    }
    ...
    public final void searchingForMappingDocuments(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000235: ")+ searchingForMappingDocuments$str()), name);
    }
    ...
    public final void usingAstQueryTranslatorFactory() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000397: ")+ usingAstQueryTranslatorFactory$str()));
    }
    ...
    public final void exceptionHeaderNotFound(final String exceptionHeader, final String metaInfOrmXml) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000086: ")+ exceptionHeaderNotFound$str()), exceptionHeader, metaInfOrmXml);
    }
    ...
    public final void immutableAnnotationOnNonRoot(final String className) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000124: ")+ immutableAnnotationOnNonRoot$str()), className);
    }
    ...
    public final void honoringOptimizerSetting(final String none, final String incrementParam, final int incrementSize) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000116: ")+ honoringOptimizerSetting$str()), none, incrementParam, incrementSize);
    }
    ...
    public final void needsLimit() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000180: ")+ needsLimit$str()));
    }
    ...
    public final void fetchingDatabaseMetadata() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000102: ")+ fetchingDatabaseMetadata$str()));
    }
    ...
    public final void missingArguments(final int anticipatedNumberOfArguments, final int numberOfArguments) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000174: ")+ missingArguments$str()), anticipatedNumberOfArguments, numberOfArguments);
    }
    ...
    public final void unableToCleanUpCallableStatement(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000281: ")+ unableToCleanUpCallableStatement$str()));
    }
    ...
    public final void duplicateGeneratorName(final String name) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000069: ")+ duplicateGeneratorName$str()), name);
    }
    ...
    public final void explicitSkipLockedLockCombo() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000447: ")+ explicitSkipLockedLockCombo$str()));
    }
    ...
    public final void forcingContainerResourceCleanup() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000106: ")+ forcingContainerResourceCleanup$str()));
    }
    ...
    public final void willNotRegisterListeners() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000414: ")+ willNotRegisterListeners$str()));
    }
    ...
    public final void flushes(final long flushCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000105: ")+ flushes$str()), flushCount);
    }
    ...
    public final void writingGeneratedSchemaToFile(final String outputFile) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000417: ")+ writingGeneratedSchemaToFile$str()), outputFile);
    }
    ...
    public final void unableToLoadProperties() {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000329: ")+ unableToLoadProperties$str()));
    }
    ...
    public final void startingQueryCache(final String region) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000248: ")+ startingQueryCache$str()), region);
    }
    ...
    public final void invalidDiscriminatorAnnotation(final String className) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000133: ")+ invalidDiscriminatorAnnotation$str()), className);
    }
    ...
    public final void unableToCloseInputStreamForResource(final String resourceName, final IOException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000288: ")+ unableToCloseInputStreamForResource$str()), resourceName);
    }
    ...
    public final void unableToLoadScannedClassOrResource(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000449: ")+ unableToLoadScannedClassOrResource$str()));
    }
    ...
    public final void exceptionInAfterTransactionCompletionInterceptor(final Throwable e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000087: ")+ exceptionInAfterTransactionCompletionInterceptor$str()));
    }
    ...
    public final void secondLevelCacheMisses(final long secondLevelCacheMissCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000238: ")+ secondLevelCacheMisses$str()), secondLevelCacheMissCount);
    }
    ...
    public final void deprecatedDerbyDialect() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000430: ")+ deprecatedDerbyDialect$str()));
    }
    ...
    public final void unableToInstantiateOptimizer(final String type) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000322: ")+ unableToInstantiateOptimizer$str()), type);
    }
    ...
    public final void unableToCopySystemProperties() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000304: ")+ unableToCopySystemProperties$str()));
    }
    ...
    public final void preparedStatementAlreadyInBatch(final String sql) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000202: ")+ preparedStatementAlreadyInBatch$str()), sql);
    }
    ...
    public final void queryCacheHits(final long queryCacheHitCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000213: ")+ queryCacheHits$str()), queryCacheHitCount);
    }
    ...
    public final void unableToLoadDerbyDriver(final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000328: ")+ unableToLoadDerbyDriver$str()), message);
    }
    ...
    public final void exceptionHeaderFound(final String exceptionHeader, final String metaInfOrmXml) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000085: ")+ exceptionHeaderFound$str()), exceptionHeader, metaInfOrmXml);
    }
    ...
    public final void unableToCloseConnection(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000284: ")+ unableToCloseConnection$str()));
    }
    ...
    public final void validatorNotFound() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000410: ")+ validatorNotFound$str()));
    }
    ...
    public final void failed(final Throwable throwable) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000099: ")+ failed$str()), throwable);
    }
    ...
    public final void packageNotFound(final String packageName) {
        super.log.logf(FQCN, (Logger.Level.DEBUG), null, ((projectCode +"000194: ")+ packageNotFound$str()), packageName);
    }
    ...
    public final void failSafeCollectionsCleanup(final CollectionLoadContext collectionLoadContext) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000100: ")+ failSafeCollectionsCleanup$str()), collectionLoadContext);
    }
    ...
    public final void unableToRemoveBagJoinFetch() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000358: ")+ unableToRemoveBagJoinFetch$str()));
    }
    ...
    public final void creatingSubcontextInfo(final String intermediateContextName) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000053: ")+ creatingSubcontextInfo$str()), intermediateContextName);
    }
    ...
    public final void invalidPrimaryKeyJoinColumnAnnotation() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000137: ")+ invalidPrimaryKeyJoinColumnAnnotation$str()));
    }
    ...
    public final void unableToInstantiateConfiguredSchemaNameResolver(final String resolverClassName, final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000320: ")+ unableToInstantiateConfiguredSchemaNameResolver$str()), resolverClassName, message);
    }
    ...
    public final void unableToLogSqlWarnings(final SQLException sqle) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000335: ")+ unableToLogSqlWarnings$str()), sqle);
    }
    ...
    public final void unableToCreateProxyFactory(final String entityName, final org.hibernate.HibernateException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000305: ")+ unableToCreateProxyFactory$str()), entityName);
    }
    ...
    public final void handlingTransientEntity() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000114: ")+ handlingTransientEntity$str()));
    }
    ...
    public final void failSafeEntitiesCleanup(final EntityLoadContext entityLoadContext) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000101: ")+ failSafeEntitiesCleanup$str()), entityLoadContext);
    }
    ...
    public final void columns(final Set keySet) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000037: ")+ columns$str()), keySet);
    }
    ...
    public final void unableToWriteCachedFile(final String path, final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000378: ")+ unableToWriteCachedFile$str()), path, message);
    }
    ...
    public final void readOnlyCacheConfiguredForMutableCollection(final String name) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000222: ")+ readOnlyCacheConfiguredForMutableCollection$str()), name);
    }
    ...
    public final void connectionsObtained(final long connectCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000048: ")+ connectionsObtained$str()), connectCount);
    }
    ...
    public final void entitiesDeleted(final long entityDeleteCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000076: ")+ entitiesDeleted$str()), entityDeleteCount);
    }
    ...
    public final void unableToRunSchemaUpdate(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000366: ")+ unableToRunSchemaUpdate$str()));
    }
    ...
    public final void unableToBuildEnhancementMetamodel(final String className) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000279: ")+ unableToBuildEnhancementMetamodel$str()), className);
    }
    ...
    public final void cachedFileNotFound(final String path, final FileNotFoundException error) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000023: ")+ cachedFileNotFound$str()), path, error);
    }
    ...
    public final void readingCachedMappings(final File cachedFile) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000219: ")+ readingCachedMappings$str()), cachedFile);
    }
    ...
    public final void unsupportedInitialValue(final String propertyName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000392: ")+ unsupportedInitialValue$str()), propertyName);
    }
    ...
    public final void duplicateImport(final String entityName, final String rename) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000071: ")+ duplicateImport$str()), entityName, rename);
    }
    ...
    public final void noDefaultConstructor(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000182: ")+ noDefaultConstructor$str()), name);
    }
    ...
    public final void jndiNameDoesNotHandleSessionFactoryReference(final String sfJNDIName, final ClassCastException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000155: ")+ jndiNameDoesNotHandleSessionFactoryReference$str()), sfJNDIName);
    }
    ...
    public final void unableToReleaseContext(final String message) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000354: ")+ unableToReleaseContext$str()), message);
    }
    ...
    public final void requiredDifferentProvider(final String provider) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000226: ")+ requiredDifferentProvider$str()), provider);
    }
    ...
    public final void unableToBindEjb3ConfigurationToJndi(final org.hibernate.engine.jndi.JndiException e) {
        super.log.logf(FQCN, (Logger.Level.WARN), (e), ((projectCode +"000276: ")+ unableToBindEjb3ConfigurationToJndi$str()));
    }
    ...
    public final void parsingXmlErrorForFile(final String file, final int lineNumber, final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000197: ")+ parsingXmlErrorForFile$str()), file, lineNumber, message);
    }
    ...
    public final void unableToLocateConfiguredSchemaNameResolver(final String resolverClassName, final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000331: ")+ unableToLocateConfiguredSchemaNameResolver$str()), resolverClassName, message);
    }
    ...
    public final void configuredSessionFactory(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000041: ")+ configuredSessionFactory$str()), name);
    }
    ...
    public final void entitiesInserted(final long entityInsertCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000078: ")+ entitiesInserted$str()), entityInsertCount);
    }
    ...
    public final void jdbcIsolationLevel(final String isolationLevelToString) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000149: ")+ jdbcIsolationLevel$str()), isolationLevelToString);
    }
    ...
    public final void unableToFindPersistenceXmlInClasspath() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000318: ")+ unableToFindPersistenceXmlInClasspath$str()));
    }
    ...
    public final void unableToWrapResultSet(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.INFO), (e), ((projectCode +"000377: ")+ unableToWrapResultSet$str()));
    }
    ...
    public final void exceptionInBeforeTransactionCompletionInterceptor(final Throwable e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000088: ")+ exceptionInBeforeTransactionCompletionInterceptor$str()));
    }
    ...
    public final void statementsPrepared(final long prepareStatementCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000253: ")+ statementsPrepared$str()), prepareStatementCount);
    }
    ...
    public final void propertiesNotFound() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000206: ")+ propertiesNotFound$str()));
    }
    ...
    public final void configuringFromXmlDocument() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000045: ")+ configuringFromXmlDocument$str()));
    }
    ...
    public final void expired(final Object key) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000092: ")+ expired$str()), key);
    }
    ...
    public final void exceptionInSubResolver(final String message) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000089: ")+ exceptionInSubResolver$str()), message);
    }
    ...
    public final void usingOldDtd() {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000404: ")+ usingOldDtd$str()));
    }
    ...
    public final void unableToObtainConnectionMetadata(final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000341: ")+ unableToObtainConnectionMetadata$str()), message);
    }
    ...
    public final void unableToMarkForRollbackOnPersistenceException(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000337: ")+ unableToMarkForRollbackOnPersistenceException$str()));
    }
    ...
    public final void compositeIdClassDoesNotOverrideHashCode(final String name) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000039: ")+ compositeIdClassDoesNotOverrideHashCode$str()), name);
    }
    ...
    public final void schemaExportUnsuccessful(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000231: ")+ schemaExportUnsuccessful$str()));
    }
    ...
    public final void unableToToggleAutoCommit(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000372: ")+ unableToToggleAutoCommit$str()));
    }
    ...
    public final void overridingTransactionStrategyDangerous(final String transactionStrategy) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000193: ")+ overridingTransactionStrategyDangerous$str()), transactionStrategy);
    }
    ...
    public final void updatingSchema() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000396: ")+ updatingSchema$str()));
    }
    ...
    public final void unsupportedIngresVersion() {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000391: ")+ unsupportedIngresVersion$str()));
    }
    ...
    public final void invalidArrayElementType(final String message) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000132: ")+ invalidArrayElementType$str()), message);
    }
    ...
    public final void unableToDestroyCache(final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000308: ")+ unableToDestroyCache$str()), message);
    }
    ...
    public final void unableToCompleteSchemaValidation(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000300: ")+ unableToCompleteSchemaValidation$str()));
    }
    ...
    public final void unableToDropTemporaryIdTable(final String message) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000314: ")+ unableToDropTemporaryIdTable$str()), message);
    }
    ...
    public final void serviceProperties(final Properties properties) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000240: ")+ serviceProperties$str()), properties);
    }
    ...
    public final void collectionsLoaded(final long collectionLoadCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000033: ")+ collectionsLoaded$str()), collectionLoadCount);
    }
    ...
    public final void unableToReleaseIsolatedConnection(final Throwable ignore) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000356: ")+ unableToReleaseIsolatedConnection$str()), ignore);
    }
    ...
    public final void unableToObtainInitialContext(final NamingException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000343: ")+ unableToObtainInitialContext$str()));
    }
    ...
    public final void unableToCloseInitialContext(final String string) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000285: ")+ unableToCloseInitialContext$str()), string);
    }
    ...
    public final void transactionStrategy(final String strategyClassName) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000268: ")+ transactionStrategy$str()), strategyClassName);
    }
    ...
    public final void hydratingEntitiesCount(final int size) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000119: ")+ hydratingEntitiesCount$str()), size);
    }
    ...
    public final void containsJoinFetchedCollection(final String role) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000051: ")+ containsJoinFetchedCollection$str()), role);
    }
    ...
    public final void usingDefaultTransactionStrategy() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000399: ")+ usingDefaultTransactionStrategy$str()));
    }
    ...
    public final void optimisticLockFailures(final long optimisticFailureCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000187: ")+ optimisticLockFailures$str()), optimisticFailureCount);
    }
    ...
    public final void invalidSubStrategy(final String className) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000138: ")+ invalidSubStrategy$str()), className);
    }
    ...
    public final void configurationResource(final String resource) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000040: ")+ configurationResource$str()), resource);
    }
    ...
    public final void naturalIdCacheHits(final long naturalIdCacheHitCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000439: ")+ naturalIdCacheHits$str()), naturalIdCacheHitCount);
    }
    ...
    public final void usingHibernateBuiltInConnectionPool() {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000402: ")+ usingHibernateBuiltInConnectionPool$str()));
    }
    ...
    public final void factoryUnboundFromJndiName(final String name) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000097: ")+ factoryUnboundFromJndiName$str()), name);
    }
    ...
    public final void loadingCollectionKeyNotFound(final CollectionKey collectionKey) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000159: ")+ loadingCollectionKeyNotFound$str()), collectionKey);
    }
    ...
    public final void unknownSqlServerVersion(final int databaseMajorVersion) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000385: ")+ unknownSqlServerVersion$str()), databaseMajorVersion);
    }
    ...
    public final void naturalIdCachePuts(final long naturalIdCachePutCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000438: ")+ naturalIdCachePuts$str()), naturalIdCachePutCount);
    }
    ...
    public final void closingUnreleasedBatch() {
        super.log.logf(FQCN, (Logger.Level.DEBUG), null, ((projectCode +"000420: ")+ closingUnreleasedBatch$str()));
    }
    ...
    public final void noColumnsSpecifiedForIndex(final String indexName, final String tableName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000432: ")+ noColumnsSpecifiedForIndex$str()), indexName, tableName);
    }
    ...
    public final void unableToReadOrInitHiValue(final SQLException e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000351: ")+ unableToReadOrInitHiValue$str()));
    }
    ...
    public final void synchronizationFailed(final javax.transaction.Synchronization synchronization, final Throwable t) {
        super.log.logf(FQCN, (Logger.Level.ERROR), null, ((projectCode +"000260: ")+ synchronizationFailed$str()), synchronization, t);
    }
    ...
    public final void naturalIdCacheMisses(final long naturalIdCacheMissCount) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000440: ")+ naturalIdCacheMisses$str()), naturalIdCacheMissCount);
    }
    ...
    public final void couldNotBindJndiListener() {
        super.log.logf(FQCN, (Logger.Level.DEBUG), null, ((projectCode +"000127: ")+ couldNotBindJndiListener$str()));
    }
    ...
    public final void ignoringUnrecognizedQueryHint(final String hintName) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000121: ")+ ignoringUnrecognizedQueryHint$str()), hintName);
    }
    ...
    public final void unableToBindValueToParameter(final String nullSafeToString, final int index, final String message) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000278: ")+ unableToBindValueToParameter$str()), nullSafeToString, index, message);
    }
    ...
    public final void unableToCreateSchema(final Exception e) {
        super.log.logf(FQCN, (Logger.Level.ERROR), (e), ((projectCode +"000306: ")+ unableToCreateSchema$str()));
    }
    ...
    public final void jndiInitialContextProperties(final Hashtable hash) {
        super.log.logf(FQCN, (Logger.Level.INFO), null, ((projectCode +"000154: ")+ jndiInitialContextProperties$str()), hash);
    }
    ...
    public final void entityManagerFactoryAlreadyRegistered(final String emfName, final String propertyName) {
        super.log.logf(FQCN, (Logger.Level.WARN), null, ((projectCode +"000436: ")+ entityManagerFactoryAlreadyRegistered$str()), emfName, propertyName);
    }
